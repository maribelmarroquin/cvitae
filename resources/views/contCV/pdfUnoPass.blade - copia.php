...
<div class="datos">
<ul>
	<li class="txt_datos">Feha de nacimiento: <b>{{ $dp->fecha_nac }}</b></li>
	<li class="txt_datos">Teléfono: <b>{{ $dp->telefono }}</b></li>
	<li class="txt_datos">Domicilio: <b>{{ $dp->direccion }}</b></li>
	<li class="txt_datos">E-mail: <b>{{ $dp->email_u }}</b></li>
	<li class="txt_datos">Sitio web: <b>{{ $dp->sitio }}</b></li>
</ul>
</div>
<div class="web">
	<h5 class="titulopass_datos">Más información: </h5>
	<p class="pass_datos">
                <a href="https://cvitae.x10.mx/loginConsulta">https://cvitae.x10.mx/loginConsulta</a><br>
                Usuario: {{ $userConsulta }}<br>
		Password: {{ $passConsulta }}
	</p>
</div>
