...
<div class="datos">
	...
	<p class="txt_datos">
		Edad: <b>{{ $dp->fecha_nac }} años</b> <img src="open-iconic/png/eye.png"> Teléfono/celular: <b>{{ $dp->telefono }}</b><br> E-mail: <b>{{ $dp->email_u }}</b> <img src="open-iconic/png/eye.png"> 
@if($dp->sitio ==! "")
Sitio web: <b>{{ $dp->sitio }}</b>
@endif
</p>
